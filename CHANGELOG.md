...
- WebChat/compaction status: ignore compaction lifecycle events for other sessions when the current chat is idle, preventing stale “Compacting context...” banners from sticking on unrelated chats. (#39908) Thanks @liuxiaopai-ai.
