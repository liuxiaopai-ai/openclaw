...
- Agents/tool retry warnings: treat `file_path`-style edit/write aliases as stable mutation targets so successful retries clear stale tool failure warnings instead of leaking internal retry noise into chat surfaces. (#39916)
