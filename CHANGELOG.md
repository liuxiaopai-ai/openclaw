...
- Gateway/TUI session titles: prefer the computed session display name and strip injected inbound metadata blocks before falling back to transcript text, so gateway-routed sessions no longer show `untrusted metadata` as their title. (#39722)
