...
- Sandbox/env warnings: stop flagging long alphanumeric-only env var values as base64-like credential data, while keeping warnings for longer padded base64-shaped payloads. (#39680)
