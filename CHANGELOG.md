...
- Internal message hooks: deliver `event.messages` from `message:received` and `message:sent` hooks back to the user-facing conversation without recursively re-triggering message hooks. (#39688)
