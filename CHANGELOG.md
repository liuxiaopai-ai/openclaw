...
- Agent/skills snapshots: refresh stored workspace skill paths when an existing session resumes under a moved workspace, so `sessions.json` does not keep serving stale iCloud-era `skills/*/SKILL.md` locations after a workspace migration. (#39719)
