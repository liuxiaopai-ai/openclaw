...
- ACP/client: suppress doctor preflight notes on stdout for `openclaw acp client` so NDJSON protocol streams are not polluted by banner-style warning boxes during startup. (#39789)
