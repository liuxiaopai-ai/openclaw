...
- Sandbox/env-var warnings: tighten the base64 credential heuristic to require longer values plus valid base64 structure markers, so long plain alphanumeric env vars stop triggering false-positive credential warnings. (#39680)
