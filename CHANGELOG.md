...
- Auth/OAuth sibling sync: propagate OAuth credentials into sibling agent auth stores even when a target `agents/<id>/agent` directory has not been created yet, so newly added agents can reuse successful login state on first launch. (#39928, #39925)
