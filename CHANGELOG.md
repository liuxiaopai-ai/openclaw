...
- Plugins/uninstall: remove `channels.<pluginId>` config alongside plugin entries/install records during `openclaw plugins uninstall`, avoiding validation failures when uninstalling channel plugins with persisted channel settings. (#39878) Thanks @liuxiaopai-ai.
