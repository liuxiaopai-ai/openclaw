...
vi.mock("openclaw/plugin-sdk/llm-task", async (importOriginal) => {
  const actual = await importOriginal<typeof import("openclaw/plugin-sdk/llm-task")>();
  return {
    ...actual,
...
import { runEmbeddedPiAgent } from "openclaw/plugin-sdk/llm-task";
